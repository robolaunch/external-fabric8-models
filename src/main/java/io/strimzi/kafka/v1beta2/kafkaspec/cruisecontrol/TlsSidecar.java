...
public class TlsSidecar implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.strimzi.kafka.v1beta2.kafkaspec.cruisecontrol.tlssidecar.LivenessProbe livenessProbe;

    public io.strimzi.kafka.v1beta2.kafkaspec.cruisecontrol.tlssidecar.LivenessProbe getLivenessProbe() {
        return livenessProbe;
    }

    public void setLivenessProbe(io.strimzi.kafka.v1beta2.kafkaspec.cruisecontrol.tlssidecar.LivenessProbe livenessProbe) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.strimzi.kafka.v1beta2.kafkaspec.cruisecontrol.tlssidecar.ReadinessProbe readinessProbe;

    public io.strimzi.kafka.v1beta2.kafkaspec.cruisecontrol.tlssidecar.ReadinessProbe getReadinessProbe() {
        return readinessProbe;
    }

    public void setReadinessProbe(io.strimzi.kafka.v1beta2.kafkaspec.cruisecontrol.tlssidecar.ReadinessProbe readinessProbe) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.strimzi.kafka.v1beta2.kafkaspec.cruisecontrol.tlssidecar.Resources resources;

    public io.strimzi.kafka.v1beta2.kafkaspec.cruisecontrol.tlssidecar.Resources getResources() {
        return resources;
    }

    public void setResources(io.strimzi.kafka.v1beta2.kafkaspec.cruisecontrol.tlssidecar.Resources resources) {

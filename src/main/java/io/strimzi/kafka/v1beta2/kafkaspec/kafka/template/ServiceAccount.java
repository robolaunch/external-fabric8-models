...
public class ServiceAccount implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.strimzi.kafka.v1beta2.kafkaspec.kafka.template.serviceaccount.Metadata metadata;

    public io.strimzi.kafka.v1beta2.kafkaspec.kafka.template.serviceaccount.Metadata getMetadata() {
        return metadata;
    }

    public void setMetadata(io.strimzi.kafka.v1beta2.kafkaspec.kafka.template.serviceaccount.Metadata metadata) {

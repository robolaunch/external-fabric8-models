...
@com.fasterxml.jackson.annotation.JsonPropertyOrder({"class","deleteClaim","id","overrides","selector","size","sizeLimit","type","volumes"})
...
public class Storage implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.strimzi.kafka.v1beta2.kafkaspec.kafka.storage.Overrides> overrides;

    public java.util.List<io.strimzi.kafka.v1beta2.kafkaspec.kafka.storage.Overrides> getOverrides() {
        return overrides;
    }

    public void setOverrides(java.util.List<io.strimzi.kafka.v1beta2.kafkaspec.kafka.storage.Overrides> overrides) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.strimzi.kafka.v1beta2.kafkaspec.kafka.storage.Selector selector;

    public io.strimzi.kafka.v1beta2.kafkaspec.kafka.storage.Selector getSelector() {
        return selector;
    }

    public void setSelector(io.strimzi.kafka.v1beta2.kafkaspec.kafka.storage.Selector selector) {
    ...
    public enum Type {
        ...
        PERSISTENTCLAIM("persistent-claim"), @com.fasterxml.jackson.annotation.JsonProperty("jbod")
        JBOD("jbod");
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Storage type, must be either 'ephemeral', 'persistent-claim', or 'jbod'.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private Type type;
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("List of volumes as Storage objects representing the JBOD disks array.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.strimzi.kafka.v1beta2.kafkaspec.kafka.storage.Volumes> volumes;

    public java.util.List<io.strimzi.kafka.v1beta2.kafkaspec.kafka.storage.Volumes> getVolumes() {
        return volumes;
    }

    public void setVolumes(java.util.List<io.strimzi.kafka.v1beta2.kafkaspec.kafka.storage.Volumes> volumes) {

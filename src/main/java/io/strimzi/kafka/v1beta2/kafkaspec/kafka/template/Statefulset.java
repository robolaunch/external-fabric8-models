...
public class Statefulset implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.strimzi.kafka.v1beta2.kafkaspec.kafka.template.statefulset.Metadata metadata;

    public io.strimzi.kafka.v1beta2.kafkaspec.kafka.template.statefulset.Metadata getMetadata() {
        return metadata;
    }

    public void setMetadata(io.strimzi.kafka.v1beta2.kafkaspec.kafka.template.statefulset.Metadata metadata) {

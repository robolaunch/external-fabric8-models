...
public class JvmOptions implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.strimzi.kafka.v1beta2.kafkaspec.kafka.jvmoptions._XX _XX;

    public io.strimzi.kafka.v1beta2.kafkaspec.kafka.jvmoptions._XX get_XX() {
        return _XX;
    }

    public void set_XX(io.strimzi.kafka.v1beta2.kafkaspec.kafka.jvmoptions._XX _XX) {
        this._XX = _XX;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.strimzi.kafka.v1beta2.kafkaspec.kafka.jvmoptions.JavaSystemProperties> javaSystemProperties;

    public java.util.List<io.strimzi.kafka.v1beta2.kafkaspec.kafka.jvmoptions.JavaSystemProperties> getJavaSystemProperties() {
        return javaSystemProperties;
    }

    public void setJavaSystemProperties(java.util.List<io.strimzi.kafka.v1beta2.kafkaspec.kafka.jvmoptions.JavaSystemProperties> javaSystemProperties) {

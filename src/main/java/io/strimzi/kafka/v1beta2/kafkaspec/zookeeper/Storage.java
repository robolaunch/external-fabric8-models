...
public class Storage implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.strimzi.kafka.v1beta2.kafkaspec.zookeeper.storage.Overrides> overrides;

    public java.util.List<io.strimzi.kafka.v1beta2.kafkaspec.zookeeper.storage.Overrides> getOverrides() {
        return overrides;
    }

    public void setOverrides(java.util.List<io.strimzi.kafka.v1beta2.kafkaspec.zookeeper.storage.Overrides> overrides) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.strimzi.kafka.v1beta2.kafkaspec.zookeeper.storage.Selector selector;

    public io.strimzi.kafka.v1beta2.kafkaspec.zookeeper.storage.Selector getSelector() {
        return selector;
    }

    public void setSelector(io.strimzi.kafka.v1beta2.kafkaspec.zookeeper.storage.Selector selector) {
